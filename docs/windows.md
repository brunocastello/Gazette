...
| `Gazette Cache` folder | `Cache` folder (was `Gazette Cache` until 2026-09-26; renamed on first use) |
| `Gazette Cache:Feed XXXXXXXX` | `Cache\Feed XXXXXXXX` |
| `Gazette Cache:Gazette Index` | `Cache\Gazette Index` |
