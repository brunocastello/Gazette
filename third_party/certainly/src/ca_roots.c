 ...
 *   python3 tools/generate_ca_roots.py --out /tmp/ca_all.c
 *
 * Mac OS 9 has no usable system trust store, so this list is the
 * whole of what Gateway will trust. Anchors (129):
 ...
 *   CN=Chambers of Commerce Root - 2008,O=AC Camerfirma S.A.,2.5.4.5=A82743287,L=Madrid (see current address at www.camerfirma.com/address),C=EU
 ...
 *   CN=Global Chambersign Root - 2008,O=AC Camerfirma S.A.,2.5.4.5=A82743287,L=Madrid (see current address at www.camerfirma.com/address),C=EU
...
const br_x509_trust_anchor TAs[129] = {
	{
